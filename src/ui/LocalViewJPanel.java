 ...
 * @author LENOVO
 */
public class LocalViewJPanel extends javax.swing.JPanel {

    /**
     * Creates new form LocalViewJPanel
     */
    LocalInfo infor;
    
    public LocalViewJPanel(LocalInfo infor) {
        initComponents();
        this.infor = infor;
    ...
    private void initComponents() {
        ...
        tblLocalAddress.setBackground(new java.awt.Color(255, 102, 51));
    ...
    private void btnViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewActionPerformed
        ...
        Local selectedLocals = (Local) model.getValueAt(selectedRowIndex, 0);

        txtApartment.setText(selectedLocals.getApartment());
        txtCity.setText(selectedLocals.getCity());
        txtState.setText(selectedLocals.getState());
        txtZipcode.setText(selectedLocals.getZipcode());
        txtCountry.setText(selectedLocals.getCountry());
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        infor.deleteLocals(selectedLocals);
