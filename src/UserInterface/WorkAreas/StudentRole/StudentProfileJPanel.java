...
public class StudentProfileJPanel extends javax.swing.JPanel {
    ...
    public StudentProfileJPanel(Business bz, StudentProfile studentProfile, JPanel jp) {
    ...
    private void prefill() {
        txtEmail.setText(sp.getPerson().getEmail());
        txtName.setText(sp.getPerson().getName());
        UserAccountDirectory uad = business.getUserAccountDirectory();
        UserAccount ua = uad.findUserAccount(sp.getPerson().getId());
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        sp.getPerson().setName(txtName.getText());
        sp.getPerson().setEmail(txtEmail.getText());
