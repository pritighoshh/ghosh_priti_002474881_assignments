...
//        ProcessOrder aos = new ProcessOrder(business, selectedcustomer ,salesperson, CardSequencePanel);
    ...
    private void btnProfileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProfileActionPerformed
        ...
        StudentProfileJPanel aos = new StudentProfileJPanel(business, student, CardSequencePanel);
        // aos.setAgenda(businessunit.getRiskManagementAgenda());
        CardSequencePanel.add("ManageVulns", aos);
        ((java.awt.CardLayout) CardSequencePanel.getLayout()).next(CardSequencePanel);
    ...
    private void btnAuditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAuditActionPerformed
        ...
        if(student.isApplied()){
           JOptionPane.showMessageDialog(this, " Already Applied for graduation, wait for results"); 
           return;
        }
        
        if (!student.isGraduated()) {
            student.applyTograduate();
            JOptionPane.showMessageDialog(this, "Successfully applied for graduation");
        } else {
            JOptionPane.showMessageDialog(this, "Graduated!");
        }
    ...
    private void btnRegistrationActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrationActionPerformed
        ...
        ViewCoursesJPanel vcjp = new ViewCoursesJPanel(business, student, CardSequencePanel);
        // aos.setAgenda(businessunit.getRiskManagementAgenda());
        CardSequencePanel.add("registerCourses", vcjp);
        ((java.awt.CardLayout) CardSequencePanel.getLayout()).next(CardSequencePanel);
    ...
    private void btnTranscriptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTranscriptActionPerformed
        ...
        TranscriptJPanel tjp = new TranscriptJPanel(business, student, CardSequencePanel);
        // aos.setAgenda(businessunit.getRiskManagementAgenda());
        CardSequencePanel.add("transcript", tjp);
        ((java.awt.CardLayout) CardSequencePanel.getLayout()).next(CardSequencePanel);
