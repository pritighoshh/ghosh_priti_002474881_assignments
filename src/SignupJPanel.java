...
public class SignupJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(lblName);
        lblName.setBounds(90, 80, 52, 16);

        lblAge.setText("Age");
        add(lblAge);
        lblAge.setBounds(90, 120, 52, 16);

        lblEmail.setText("Email");
        add(lblEmail);
        lblEmail.setBounds(90, 160, 53, 16);

        lblUserName.setText("Username");
        add(lblUserName);
        lblUserName.setBounds(85, 197, 53, 16);

        lblPassword.setText("Password");
        add(lblPassword);
        lblPassword.setBounds(85, 225, 53, 16);
        add(txtName);
        txtName.setBounds(190, 80, 100, 22);
        add(txtAge);
        txtAge.setBounds(190, 110, 100, 22);
        add(txtEmail);
        txtEmail.setBounds(190, 150, 100, 22);
        add(txtUsername);
        txtUsername.setBounds(190, 190, 100, 22);
        add(txtPassword);
        txtPassword.setBounds(190, 220, 100, 22);
        ...
        add(btnSignup);
        btnSignup.setBounds(146, 316, 72, 23);
        ...
        add(dropUserType);
        dropUserType.setBounds(192, 260, 100, 22);

        lblUserType.setText("User Type");
        add(lblUserType);
        lblUserType.setBounds(90, 260, 53, 16);
